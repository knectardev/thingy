...
const REPO_URL = "https://github.com/knectardev/thingy";
...
export default function TopBar({ onAboutClick }: TopBarProps) {
  return (
    <nav className="flex items-center justify-between border-b border-gray-200 py-3 dark:border-gray-700">
      <a
        href={REPO_URL}
        target="_blank"
      ...
      <button
        ...
        className="flex items-center gap-1.5 text-sm text-gray-600 transition-colors hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200"
      >
